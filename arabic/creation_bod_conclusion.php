...
<body class="page_inner">
  ...
  ?>
<div class="page_creation_bod_conclusion">
  <div class="cont_left col5 bk_purple">
    <div class="media_content">
      <div class="element_bars_hr" style="width: 100%;margin-bottom: 50px;margin-top: 50px;left: 0;height: 55px;position: relative;">
  ...
  <div class="cont_right col5 bk_purple">
