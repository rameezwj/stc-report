  ...
  if(true){
    ...
    // what to do when user clicks on the submenu items
      ...
      jQuery('.sub_menu_wrapper .submenu_content a').click(function(){
        ...
        var goto_url = window.location.origin+'/stc2020/arabic/'+page_link+".php";
...
// scrollmagic
    ...
    jQuery('.bod_items').each(function(){
      ...
      tl_bod.staggerFromTo(jQuery(this).find(`img`), 1.5, {y: 0, opacity: 0, ease: Power3.easeOut }, { opacity: 1, y: 0, ease: Power4.easeInOut })
      .staggerFromTo(jQuery(this).find(`p, span`), 2, {y: 100, opacity: 0, ease: Power3.easeOut }, { opacity: 1, y: 0, ease: Power4.easeInOut }, .1, '-=1.5')
